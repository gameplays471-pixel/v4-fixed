...
import "@/lib/api"; // importado para side-effects (formatters usados em outros módulos)
...
export default function Home() {
  ...
  useEffect(() => {
    // Verifica sessão via cookie httpOnly — o browser o envia automaticamente
  ...
  const handleLogout = async () => {
    // Chama o endpoint de logout para apagar o cookie no servidor
...
function MobileBottomNav() {
  ...
  const items: Array<{ key: typeof view; label: string; icon: React.ReactNode }> = [
