...
const navItems: Array<{ href: string; label: string; emoji: string; icon: React.ReactNode; matchPrefix?: boolean }> = [
  {
  ...
  {
    href: "/biblioteca", label: "Exercícios", emoji: "📚",
  ...
  {
    href: "/stats", label: "Estatísticas", emoji: "📊",
